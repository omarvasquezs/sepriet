...
public class frmMain extends javax.swing.JFrame {
    ...
    public frmMain() {
        ...
        menuConsultarComprobantesNoCancelados.addActionListener(new java.awt.event.ActionListener() {
            @Override
            public void actionPerformed(java.awt.event.ActionEvent e) {
                openComprobantesFrame(frmConsultarComprobantes.Mode.RECIBIDOS);
            }
        });
        menuConsultarComprobantesCancelados.addActionListener(new java.awt.event.ActionListener() {
            @Override
            public void actionPerformed(java.awt.event.ActionEvent e) {
                openComprobantesFrame(frmConsultarComprobantes.Mode.CANCELADOS);
            }
        });
    ...
    private void menuConsultarClientsAction() {
        menuConsultarClientes.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                ...
                for (javax.swing.JInternalFrame f : desktopPane.getAllFrames()) {
                    if (f instanceof frmConsultarClientes) {
                        try {
                            f.setSelected(true);

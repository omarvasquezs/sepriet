...
public class DlgNuevoCliente extends JDialog {
    ...
    private void buildUI() {
        ...
        txtNombres.setFont(fieldFont);
        txtNombres.setPreferredSize(new Dimension(480, 34));
        ...
        txtEmail.setPreferredSize(new Dimension(360, 34));
        ...
        form.add(lblDireccion, c);
        // place textarea inside a scrollpane and allow it to expand vertically
        c.gridx = 1;
        c.weightx = 1;
        c.weighty = 1;
        c.fill = GridBagConstraints.BOTH;
        JScrollPane sp = new JScrollPane(txtDireccion, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,

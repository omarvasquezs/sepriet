    ...
    private void saveComprobante() {
        ...
        try (Connection conn = DatabaseConfig.getConnection()) {
            ...
            String insertComprobanteSql = "INSERT INTO comprobantes " +
                    ...
                    "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?, " +
                    (estadoComprobanteId == 4 ? "?" : "NULL") + ", NULL)";
            try (PreparedStatement ps = conn.prepareStatement(insertComprobanteSql,
                ...
                if (estadoComprobanteId == 4) {
                    ps.setTimestamp(17, java.sql.Timestamp.valueOf(fecha));
                }
                ps.executeUpdate();
                int comprobanteId;
                ...
                try (PreparedStatement psIng = conn.prepareStatement(ingresoSql)) {
                    ...
                    psIng.setTimestamp(4, java.sql.Timestamp.valueOf(fecha));
